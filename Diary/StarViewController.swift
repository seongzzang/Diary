...
class StarViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(starDiaryNotificiation(_:)), name: NSNotification.Name("starDiary"), object: nil)
    ...
    @objc func starDiaryNotificiation(_ notification: Notification){
